...
//            ---------------------B--------------------
            ...
            case "BES" : return "Bonaire, Saint Eustatius and Saba";
...
//            ---------------------E--------------------
            ...
            case "EUE" : return "European Union";
...
//            ---------------------G--------------------
            ...
            case "GBD" : return "British Overseas Territories Citizen ";
            case "GBN" : return "British National (Overseas)";
            case "GBO" : return "British Overseas Citizen";
            case "GBP" : return "British Protected Person";
            case "GBS" : return "British Subject";
//            ---------------------H--------------------
...
//            ----------------EXTRA CODE----------------
            case "XOM" : return "Sovereign Military Order of Malta";
            case "XPO" : return "Interpol travel documents";
            case "XXA" : return "stateless person";
            case "XXB" : return "refugee";
            case "XXC" : return "refugee";
            case "XXX" : return "unspecified nationality";
            case "WSA" : return "World Service Authority World Passport";
            case "UNA" : return "Specialized agency of the United Nations";
            case "UNK" : return "Resident of Kosovo to whom a travel document has been issued by the United Nations Interim Administration Mission in Kosovo (UNMIK)";
            case "UNO" : return "United Nations Organization";
            case "XBA" : return "African Development Bank";
            case "XIM" : return "African Export–Import Bank";
            case "XCC" : return "Caribbean Community or one of its emissaries";
